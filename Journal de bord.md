...
# 23/4/19
Arguments pour les textes des plot : https://matplotlib.org/api/text_api.html#matplotlib.text.Text
- 🆙 Nébuleuse : msa (définition sequence master) + WebLogo + Clustal
- 🆙 Proteinus : msa + WebLogo + Clustal ; 🆙 Chiméra : rédaction
# 24/4/19
- commit des repo pypro*
- 🆙 Nébuleuse : implémentation fonction pour intersection entre PDB chiméra et UniProt
- 🆙 Nébuleuse : add intersection + affichage graphique
- 🆙 Proteinus : 🆙 de la doc
# 25/4/19
